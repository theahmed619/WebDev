...
function Collections() {
  ...
  return (
    <div className='w-[98vw]  min-h-[99vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start flex-col md:flex-row justify-start  pt-[70px] overflow-x-hidden z-[2] pb-[110px]'>
