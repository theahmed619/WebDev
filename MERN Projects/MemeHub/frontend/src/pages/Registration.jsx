...
import Logo from "../../public/lust.png"; // Assumed path for your MemeHub logo
...
// import { authDataContext } from "../context/authContext"; // <-- REMOVE THIS
// import axios from "axios"; // No longer needed here
import { signInWithPopup } from "firebase/auth";
import { auth, provider } from "../../utils/Firebase"; // Assumed path
// import { userDataContext } from "../context/UserContext"; // <-- REMOVE THIS
...
function Registration() {
  ...
  // 3. All of these are no longer needed, the context handles them
  ...
  const googleSignup = async () => {
    try {
      ...
      // Google sign up and login use the same endpoint
    ...
    <div className="w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start">
      ...
      <div className="w-[100%] h-[100px] flex items-center justify-center flex-col gap-[10px]">
        ...
        <span className="text-[16px]">
          Welcome to MemeHub, create an account
        </span>
      </div>
