...
const HomeCard = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-5 lg:gap-0 justify-between items-center mb-20 lg:mb-36" id="home">
      <div data-aos="fade-up-right" className="flex flex-col gap-5 lg:w-[50%]">
        ...
        <p className="text-gray-300 text-xl lg:text-2xl ">
          My name is Ahmed, and I am a MERN Stack Developer. I am 20 years old
      ...
      <div data-aos="fade-up-left">
        <img
          src={"https://media.licdn.com/dms/image/v2/D4E03AQFx3gbm0quQDw/profile-displayphoto-crop_800_800/B4EZk9jV5SIoAI-/0/1757674300501?e=1762992000&v=beta&t=tlMUrQ50zvsxhyFYhiDivVG4Zb2ez4PxfzTTbsErpVI"}
          alt="profile"
